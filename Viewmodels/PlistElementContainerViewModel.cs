...
public partial class PlistElementContainerViewModel : ObservableObject
{
    ...
    {
        var isContainer = element.ElementType == PlistElementType.Dictionary ||
    ...
    public void CopySelectedElements()
    {
        ...
        foreach (var item in selectedItems)
        {
            ...
            var elementXml = ToXElement(item);
    ...
    private static bool ComputeCanPasteElements
    {
        get
        {
            ...
            try
            {
                var wrappedXml = $"<root>{clipboardText}</root>";
    ...
    public void MoveElement(PlistElementViewModel source, PlistElementViewModel target)
    {
        ...
        var targetIsContainer = target.ElementType == PlistElementType.Dictionary ||
        ...
        if (!LoadedElements.Contains(source))
        {
            return;
        }
